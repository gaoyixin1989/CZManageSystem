...
/// <reference path="TreePicker/template.html" />
(function () {
    angular
      .module('SysDeptment', [])
      .run([
        ...
        function ($templateCache) {
            $templateCache.put('SysDeptment',
            "<div class=\"table-responsive public-table-main\" style='max-height: 333px;overflow-y: scroll;overflow-x:hidden;position:relative;'>\n" +
            ...
            "              class=\" tree-icon\"></i></a><span class=\" tree-label\" ng-click=\"on_user_click(row.branch)\">\n" +
    ...
    angular.module('treeGrid', ['SysDeptment']).directive('compile', ['$compile', function ($compile) {
        return {
            restrict: 'A',
    ...
    .filter('searchFor', function () {
        return function (arr, filterString, expandingProperty, colDefinitions) {
            var filtered = [];
            //only apply filter for strings 1 characters long or more
            if (!filterString ) {
