...
(function (window, document, undefined) {
    ...
    */
    ...
    var jqCache = JQLite.cache = {},
        ...
        //IE7,8对addEventListener和removeEventListener不支持，所以调换下顺序
    ...
    function $SceProvider() {
        ...
        this.$get = ['$parse', '$sniffer', '$sceDelegate', function (
            ...
            if (enabled && $sniffer.msie && $sniffer.msieDocumentMode < 7) {//原来是$sniffer.msieDocumentMode<8，gyx修改-2016-04-29
                throw $sceMinErr('iequirks',
                  'Strict Contextual Escaping does not support Internet Explorer version < 7 in quirks ' +
    ...
    function urlResolve(url, base) {
        ...
        if (msie) {
            ...
            //IE7的执行结果和ie8及以上的不同，需要修改-gyx-20160506
            if (msie > 7) {
                urlParsingNode.setAttribute("href", href);
                href = urlParsingNode.href;
            }
            else {
                var tempHost = urlParsingNode.host;
                var tempProtocol = urlParsingNode.protocol;

                urlParsingNode.setAttribute("href", href);
                href = urlParsingNode.href;
                if (urlParsingNode.host == '' || urlParsingNode.protocol == '') {
                    href = tempProtocol + '//' + tempHost + '/' + href;
                    urlParsingNode.setAttribute("href", href);
                    href = urlParsingNode.href;
                }
            }
