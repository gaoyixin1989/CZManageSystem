            ...
            function ($document, $templateCache, $compile, $q, $http, $rootScope, $timeout, $window, $controller, $injector) {
                ...
                var privateMethods = {
                    ...
                    autoFocus: function ($dialog) {
                        ...
                        var autoFocusEl = $(dialogEl).find('*[autofocus]')[0];
                        if (autoFocusEl !== null && typeof (autoFocusEl) != 'undefined') {
                            autoFocusEl.focus();
                        ...
                        var contentElements = privateMethods.filterVisibleElements($(dialogEl).find('h1,h2,h3,h4,h5,h6,p,span'));
                    ...
                    getFocusableElements: function ($dialog) {
                        ...
                        var rawElements = $(dialogEl).find(focusableElementSelector);
                    ...
                    applyAriaAttribute: function ($dialog, attr, id, selector) {
                        ...
                        if (selector) {
                            ...
                            var firstMatch = $($dialog[0]).find(selector)[0];
                    ...
                    open: function (opts) {
                        ...
                        $q.all({
                            ...
                            if (options.showClose) {
                                template += '<div class="ngdialog-close"  ng-click="closeThisDialog()"></div>';
                            }
                            var title = "";
                            if (options.title.length > 0 && options.title != "") {
                                title = '<h3 class="layertitle"><b></b>' + options.title + '</h3>';
                            }

                            var hasOverlayClass = options.overlay ? '' : ' ngdialog-no-overlay';
                            $dialog = $el('<div id="' + dialogID + '" class="ngdialog' + hasOverlayClass + '"></div>');
                            $dialog.html((options.overlay ?
                                '<div class="ngdialog-overlay"></div><div class="ngdialog-content" role="document">' + title + template + '</div>' :
                                '<div class="ngdialog-content" role="document">' + title + template + '</div>'));
                            ...
                            if (options.width) {
                                ...
                                $dialogContent = $($dialog[0]).find('.ngdialog-content')[0];
                            ...
                            if (options.appendTo && angular.isString(options.appendTo)) {
                                ...
                                $dialogParent = $(window.top.document.body);//$elements.body;
                            }
