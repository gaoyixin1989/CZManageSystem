...
angular.module('tm.pagination', []).directive('tmPagination', [function () {
    return {
        ...
        /*  template: ' <div class="paging">'+ 
              //'<a   class="current"  ng-show="conf.totalItems >◀</a>' + 
              '<a class="current"  ng-class="{disabled: conf.currentPage == 1}" ng-click="prevPage()"">◀</a>' +
             ' <a ng-repeat="item in pageList track by $index" ng-class="{active: item == conf.currentPage, separate: item == \'...\'}" ' +
