<%@ Page Language="C#" AutoEventWireup="true" Inherits="contrib_mobile_ajax_myTaskAjax" Codebehind="myTaskAjax.aspx.cs" %>
 ...
 <%
    ...
    <a href="#" class="list-group-item ui-btn-icon-right ui-icon-carat-r">
                        ...
                        <div style="margin-left: 2.8em;" onclick="$('.loading-backdrop').show();$('.loading-backdrop').showLoading();window.location='<%=AppPath%>contrib/mobile/pages/workflowview.aspx?wiid=<% =row["WorkflowInstanceId"]%>&returnurl=<%=HttpUtility.UrlEncode("myTask.aspx")%>'">
