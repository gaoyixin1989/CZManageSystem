<%@ Page Language="C#" AutoEventWireup="true" Inherits="contrib_mobile_ajax_doneReviewsAjax" Codebehind="doneReviewsAjax.aspx.cs" %>
 ...
 <%
    ...
    <a href="#" class="list-group-item ui-btn-icon-right ui-icon-carat-r">
                        ...
                        <div style="margin-left: 3rem;" onclick="$('.loading-backdrop').show();$('.loading-backdrop').showLoading();window.location='<%=AppPath%>contrib/mobile/pages/workflowview.aspx?wiid=<% =row["WorkflowInstanceId"]%>&returnurl=doneReviews.aspx'">
