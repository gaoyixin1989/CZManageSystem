<%@ Page Title="" Language="C#" MasterPageFile="~/plugins/easyflow/masters/Mobile.master" AutoEventWireup="true" Inherits="contrib_mobile_pages_doneTaskByAppl" Codebehind="doneTaskByAppl.aspx.cs" %>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-xs-6 col-md-6">
                            <div class="form-group">
                                <label for="txtCreator">
                                    发起人</label>
                                <input size="16" id="txtCreator" type="text" value="" class="form-control" placeholder="发起人" />
                            </div>
                        </div>
                        <div class="col-xs-6 col-md-6">
                            <div class="form-group">
        ...
        function pullDownAction() {
            //setTimeout(function () {
                ...
                $.ajax({
                    type: "post",
                    dataType: "html",
                    url: "<%=AppPath %>contrib/mobile/ajax/doneTaskByApplAjax.aspx",
