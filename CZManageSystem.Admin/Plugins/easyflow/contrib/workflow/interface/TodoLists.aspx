<%@ Page Language="C#" MasterPageFile="~/plugins/easyflow/masters/Default.master" AutoEventWireup="true" Inherits="contrib_workflow_interface_TodoLists"
    Title="Untitled Page" Codebehind="TodoLists.aspx.cs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="Server">
    ...
    <div class="toolBlock" style="border-bottom: solid 1px #C0CEDF; margin-bottom: 10px;
        ...
        流程：<asp:DropDownList ID="ddlWorkflows" runat="server">
        </asp:DropDownList>
    ...
    <script language="javascript" type="text/javascript">
        $(function() {
            ...
            $('#tblId1 tr').each(function() {
                var wiid = $(this).children('td').eq(4).html();
                var state = $(this).children('td').eq(6).html();
                if (wiid != null) {
                    WorkflowExtension.GetCurrentActNames(wiid, state, $(this).children('td').eq(4));
                    WorkflowExtension.GetCurrentActors(wiid, state, $(this).children('td').eq(5));
                }
            });
        });
</script>
