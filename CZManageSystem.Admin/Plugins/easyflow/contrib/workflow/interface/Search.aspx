<%@ Page Language="C#" MasterPageFile="~/plugins/easyflow/masters/Default.master" AutoEventWireup="true" Inherits="contrib_workflow_interface_Search" Codebehind="Search.aspx.cs" %>
		        ...
		        <tr>
		            ...
		            <td>
		                ...
		                <ajaxToolkit:AutoCompleteExtender ID="AutoCompleteExtenderCreator" runat="server" 
                            ...
                            ServicePath="../pages/WorkflowAjaxService.asmx" ServiceMethod="GetCompletionUserNames" 
		        ...
		        <tr>
		            ...
		            <td>
		                ...
		                <ajaxToolkit:AutoCompleteExtender ID="AutoCompleteExtenderTitle" runat="server" 
                            ...
                            ServicePath="../pages/WorkflowAjaxService.asmx" ServiceMethod="GetCompletionWorkflowTitles" 
