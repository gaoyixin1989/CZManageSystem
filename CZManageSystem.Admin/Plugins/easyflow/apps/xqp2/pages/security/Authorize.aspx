<%@ Page Language="C#" MasterPageFile="~/plugins/easyflow/masters/Default.master" AutoEventWireup="true" Inherits="apps_xqp2_pages_security_Authorize" Codebehind="Authorize.aspx.cs" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="ajaxToolkit" %>
<%@ Register TagPrefix="bw" TagName="ProxyTodoList" Src="../../../../contrib/workflow/controls/ProxyTodoList.ascx" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" Runat="Server">
    ...
    <div>        
        ...
        <div class="dataList">
            ...
            <bw:ProxyTodoList ID="proxyTodoList1" runat="server" />
        </div>   
    </div>
</asp:Content>
