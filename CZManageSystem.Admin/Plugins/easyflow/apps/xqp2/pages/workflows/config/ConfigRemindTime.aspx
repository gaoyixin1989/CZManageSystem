<%@ Page Language="C#" MasterPageFile="~/plugins/easyflow/masters/Default.master" AutoEventWireup="true" Inherits="apps_xqp2_pages_workflows_config_ConfigRemindTime" Codebehind="ConfigRemindTime.aspx.cs" %>
<%@ Register TagPrefix="bw" TagName="TimeSpanSelector" Src="../controls/TimeSpanSelector.ascx" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" Runat="Server">
    <div class="titleContent">
        <h3><span>[<%=Request.QueryString["name"] %>]提醒时段设置</span></h3>
    </div>
    <div class="dataList">
        ...
        <div id="divTimeSetting">
            <div class="toolBlock" style="border-bottom:solid 1px #f4f4f4;">
                ...
                提醒类型：<asp:DropDownList ID="ddlRemindType" runat="server">
                                        <asp:ListItem Value="0">待办+待阅</asp:ListItem>
                                        <asp:ListItem Value="1">待办</asp:ListItem>
                                        <asp:ListItem Value="2">待阅</asp:ListItem>
                                    </asp:DropDownList>
            ...
            <asp:GridView ID="gvRemindTimespans" DataKeyNames="TimeId" CellPadding="0" CellSpacing="0" 
                ...
                onrowupdating="gvRemindTimespans_RowUpdating"
                 OnRowDataBound="gvRemindTimespans_OnRowDataBound">
                <Columns>
