...
namespace ServiceLibrary.Domain
{
    ...
    public class userRoot
    {
        ...
        public class Data
        {
            ...
            [XmlArray("list")]
            public List<UumUserLog> list { get; set; }
            public Nullable<bool> continueFlag { get; set; }
        }


        [XmlType("EOSORG_V_EMPLOYEE_LOG")]
        public class UumUserLog
        {
            /// <summary>
            ...
            /// 加入公司日期
            /// <summary>
            public string userJoinInDate { get; set; }
            /// <summary>
            /// 民族(参考附录)
            /// <summary>
            ...
            /// <summary>
            public string userQuitDate { get; set; }
            /// <summary>
            /// 用户DN
            /// <summary>
