...
public partial class contrib_workflow_interface_WorkflowView : Botwave.Security.Web.PageBase
{
    ...
    protected void RedirectProcessPage(string currentUserName, Guid activityInstanceId)
    {
        ...
        if (isActor)
            Response.Redirect(String.Format("../pages/Process.aspx?aiid={0}", activityInstanceId));
    }
