...
public partial class contrib_workflow_pages_WorkflowView : Botwave.Security.Web.PageBase
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            if (workflowInstance.Creator.Equals(currentUserName))
                EnableUpload = true;
            else
                EnableUpload = false;
            ...
            // 流程步骤图片
            this.ImageUrl = string.Format("WorkflowImage.ashx?wid={0}&aname={1}", workflowId, HttpUtility.UrlEncode(activityName));
            ...
            this.CommentUrl = string.Format("WorkflowComment.aspx?wiid={0}&aiid={1}&actor={2}&t={3}", workflowInstanceId.ToString(), activityInstanceId.ToString(), HttpUtility.UrlEncode(actor), HttpUtility.UrlEncode(workflowTitle));
    ...
    protected void RedirectProcessPage(string currentUserName, Guid activityInstanceId)
    {
        ...
        if (isActor)
            Response.Redirect(String.Format("Process.aspx?aiid={0}", activityInstanceId));
    }
    ...
    private void LoadDynamicForm(Guid workflowId, Guid workflowInstanceId, ActivityInstance activityInstance, Botwave.Security.LoginUser user)
    {
        ...
        this.divDynamicFormContainer.InnerHtml = workflowFormService.LoadForm(workflowId, workflowInstanceId, dict);
    ...
    protected void btnRetract_Click(object sender, EventArgs e)
    {
        ...
        ShowSuccess("撤回工单成功.", AppPath + "contrib/workflow/pages/default.aspx");
    }
    ...
    protected void btnReturn_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect(AppPath + "contrib/workflow/pages/default.aspx");
    }
    ...
    protected void btnReview_Click(object sender, EventArgs e)
    {
        ...
        ShowSuccess("操作成功.", AppPath + "contrib/workflow/pages/default.aspx");
    }
