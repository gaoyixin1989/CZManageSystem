...
public partial class contrib_workflow_pages_MyTask : Botwave.Security.Web.PageBase
{
    private static string rrUrl = BasePage + "contrib/workflow/pages/mytask.aspx";
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        sbUrl.AppendFormat("?q={0}&wf={1}&st={2}&et={3}", textKeywords.Text.Trim(), HttpUtility.UrlEncode(ddlWorkflows.SelectedValue), txtStartDT.Text.Trim(), txtEndDT.Text.Trim());
