...
public partial class contrib_workflow_pages_Search : Botwave.Security.Web.PageBase
{
    ...
    private IList<WorkflowDefinition> GetAllowedWorkflows(string postfixs)
    {
        ...
        if (!this.EnableAdvance)
        {
                ...
                && postfixs != null && postfixs.Length > 0)
            {
                ...
                allowWorkflows = Botwave.XQP.Util.CZWorkflowUtility.GetAllowedWorkflows(workflows, CurrentUser.Resources, new string[] { "0004", "0005" });
