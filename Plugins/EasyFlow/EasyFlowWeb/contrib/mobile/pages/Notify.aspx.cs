...
public partial class contrib_mobile_pages_Notify : Botwave.XQP.Web.Security.PageBase
{
    /// <summary>
    /// 显示消息时返回的页面.
    /// </summary>
    private static readonly string WorkflowRootUrl = AppPath + "contrib/mobile/pages/";
    private static readonly log4net.ILog log = log4net.LogManager.GetLogger(typeof(contrib_mobile_pages_Notify));
    /// <summary>
    /// 转向页面.
    /// </summary>
    ...
    protected void OnPreRedirect()
    {
        ...
        {
            Response.Redirect(AppPath + "contrib/mobile/pages/todo.aspx");
        }
    }
