<%@ Page Title="" Language="C#" MasterPageFile="~/plugins/easyflow/masters/Mobile.master" AutoEventWireup="true" Inherits="contrib_mobile_pages_myTask" Codebehind="myTask.aspx.cs" %>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-6 col-md-6">
                            <div class="form-group">
                                <label for="txtST">
                                    时间</label>
                                <input size="16" id="txtST" type="text" value="" readonly class="form_date form-control" data-date-format="yyyy-mm-dd"  />
                            </div>
                        </div>
                        <div class="col-xs-6 col-md-6">
                            <div class="form-group">
                                <label for="txtET">
                                    至</label>
                                <input size="16" type="text" id="txtET" value="" readonly class="form_date form-control" data-date-format="yyyy-mm-dd" />
                            </div>
                        </div>
                        <div class="col-xs-6 col-md-6">
                            <div class="form-group">
        ...
        function pullDownAction() {
            //setTimeout(function () {
                ...
                $.ajax({
                    type: "post",
                    dataType: "html",
                    url: "<%=AppPath %>contrib/mobile/ajax/myTaskAjax.aspx",
