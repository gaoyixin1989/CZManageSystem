<%@ Page Title="" Language="C#" MasterPageFile="~/plugins/easyflow/masters/Mobile.master" AutoEventWireup="true" Inherits="contrib_mobile_pages_assignmentTask" Codebehind="assignmentTask.aspx.cs" %>
        ...
        function pullDownAction() {
            //setTimeout(function () {
                ...
                $.ajax({
                    type: "post",
                    dataType: "html",
                    url: "<%=AppPath %>contrib/mobile/ajax/assignmentTaskAjax.aspx",
