...
public partial class contrib_mobile_ajax_doneReviewsAjax : Botwave.XQP.Web.Security.PageBase
{
    ...
    protected void Search(int recordCount, int pageIndex)
    {
        ...
        source = ToReview.GetMpReviewDoneTable(username, workflowName, keywords, startdt, enddt, pageIndex, 10, ref recordCount);
    }
