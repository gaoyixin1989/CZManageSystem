...
public partial class contrib_mobile_ajax_doneTaskByApplAjax : Botwave.XQP.Web.Security.PageBase
{
    ...
    {
        string keywords = Context.Request["key"], workflowName = Context.Request["wfname"], creater = Context.Request["creator"], sheetID = Context.Request["sheetid"];
