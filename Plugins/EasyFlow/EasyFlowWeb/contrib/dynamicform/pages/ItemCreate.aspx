<%@ Page Language="C#" MasterPageFile="~/plugins/easyflow/masters/Default.master" AutoEventWireup="true" Inherits="contrib_dynamicform_pages_ItemCreate" Title="表单设计" ResponseEncoding="utf-8" UICulture="zh-CN" EnableEventValidation="false" Codebehind="ItemCreate.aspx.cs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="Server">
    <div class="titleContent">
        <h3><span><asp:Literal ID="ltlTitle" runat="server"></asp:Literal>表单设计</span></h3>
    </div>
    ...
    <div class="dataList"  style="padding-top:5px">   
		...
		<div class="showControl">
            ...
            <p style="text-align:center;margin-top:5px;">
                        ...
                        <input type="button" class="btnClass2l" value="从表单库生成" onclick="javascript:location.href ='choose.aspx?fdid=<%=FormDefinitionId %>&wid=<%=WorkflowId %>'"/>&nbsp;
                        ...
                        <input class="btnClass2l" onclick="javascript:location.href ='WapTemplate.aspx?fdid=<%=FormDefinitionId %>&wfid=<%=WorkflowId %>&EntityType=<%=EntityType%>'"
                         ...
                         <input type="button" class="btnClass2l" value="加入表单库" onclick="javascript:location.href ='create.aspx?fdid=<%=FormDefinitionId %>'" />
                           &nbsp;
