<%@ Page Language="C#" MasterPageFile="~/plugins/easyflow/masters/Default.master" AutoEventWireup="true" Inherits="apps_pms_pages_UCS_FromManager" Title="用户管理" Codebehind="UCS_FromManager.aspx.cs" %>

<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" Runat="Server">
    <script language="javascript" type="text/javascript">
    // <!CDATA[
    function onAddClick(){
        location = "UCS_FromManagerEdit.aspx";
    }
    // ]]>
    </script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" Runat="Server">
    ...
    <div class="toolBlock">
        ...
        <button id="btnSearch" class="btn_query" runat="server" onserverclick="btnSearch_Click">
            搜索</button> <input type="button" value="新增报表" onclick="onAddClick()" class="btnPassClass" />
    </div>
     <div id="dataDiv1">
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td style="text-align:center;">
                                ...
                                <a href="UCS_FromManagerEdit.aspx?Id=<%# Eval("id") %>">编辑</a>
                            </td>
                        </tr>
                    </ItemTemplate>
