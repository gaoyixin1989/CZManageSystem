...
public partial class apps_xqp2_pages_workflows_maintenance_Search : Botwave.Security.Web.PageBase
{
    private static readonly log4net.ILog log = log4net.LogManager.GetLogger(typeof(apps_xqp2_pages_workflows_maintenance_Search));
    ...
    {
        //WriteNomalLog(CurrentUserName, "退回工单", "234");
        Response.Redirect(string.Format("Search.aspx?bt={0}&et={1}&wname={2}&aname={3}&c={4}&a={5}&tk={6}&ck={7}&i={8}",
            dtpStart1.Text,
            dtpStart2.Text,
