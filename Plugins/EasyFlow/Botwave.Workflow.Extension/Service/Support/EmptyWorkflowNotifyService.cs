...
namespace Botwave.Workflow.Extension.Service.Support
{
    ...
    /// 流程提醒服务的空实现类.
    /// </summary>
    public class EmptyWorkflowNotifyService : IWorkflowNotifyService
    {
        ...
        {
            // bwwf_WorkflowNotifyActors_Select_Current
            return new List<NotifyActor>();
        }
        ...
        {
            // bwwf_WorkflowNotifyActors_Select_Next
            return new List<NotifyActor>();
        }
