...
namespace Botwave.Workflow.Extension.Service.Support
{
    ...
    /// 高级搜索服务的默认实现类.
    /// </summary>
    public class DefaultWorkflowSearcher : IWorkflowSearcher
    {
        ...
        /// <returns></returns>
        public DataTable Search(AdvancedSearchCondition condition, int pageIndex, int pageSize, ref int recordCount)
        {
        ...
        /// <param name="recordCount"></param>
        /// <returns></returns>
        private static DataTable DoComplexSearch(AdvancedSearchCondition condition, int pageIndex, int pageSize, ref int recordCount)
        {
            //将从0开始的页码转换为从1开始的页码
            pageIndex++;
            ...
            DataSet ds = IBatisDbHelper.ExecuteDataset(CommandType.StoredProcedure, "bwwf_ext_AdvancedSearch", paramSet);
        ...
        /// <param name="recordCount"></param>
        /// <returns></returns>
        private static DataTable DoSimpleSearch(AdvancedSearchCondition condition, int pageIndex, int pageSize, ref int recordCount)
        {
            string tableName = "vw_bwwf_SimpleSearch";
        ...
        /// <param name="recordCount"></param>
        /// <returns></returns>
        private static DataTable DoComplexSearchByProcessed(AdvancedSearchCondition condition, int pageIndex, int pageSize, ref int recordCount)
        {
            //将从0开始的页码转换为从1开始的页码
            pageIndex++;
            ...
            DataSet set = IBatisDbHelper.ExecuteDataset(CommandType.StoredProcedure, "bwwf_ext_AdvancedSearch_ByProcessed", parameterArray);
