...
namespace Botwave.XQP.Web.Controls
{
    ...
    public class MoreMenuView : Botwave.Security.Web.Controls.MenuView
    {
        #region properties
        ...
        public static string GetScript(int height)
        {
            ...
            scriptBuilder.AppendLine("  var t= reference.offsetTop + 25;");
            ...
            scriptBuilder.AppendLine("  menu.style.display=\"block\";");
            scriptBuilder.AppendLine("  var height=menu.offsetHeight+25;");
