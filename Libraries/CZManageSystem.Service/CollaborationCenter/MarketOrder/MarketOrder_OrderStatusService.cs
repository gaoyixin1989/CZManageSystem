...
{
    public class MarketOrder_OrderStatusService : BaseService<MarketOrder_OrderStatus>, IMarketOrder_OrderStatusService
    {
        /// <summary>
        /// 分页
        /// </summary>
        ...
        public override IEnumerable<dynamic> GetForPaging(out int count, object objs = null, int pageIndex = 0, int pageSize = int.MaxValue)
        {
            ...
            return new PagedList<MarketOrder_OrderStatus>(curTable.OrderBy(c => c.Order), pageIndex <= 0 ? 0 : pageIndex, pageSize, out count);
        }
    }
}
