...
{
    public class MarketOrder_AreaService : BaseService<MarketOrder_Area>, IMarketOrder_AreaService
    {
        /// <summary>
        /// 分页
        /// </summary>
        ...
        public override IEnumerable<dynamic> GetForPaging(out int count, object objs = null, int pageIndex = 0, int pageSize = int.MaxValue)
        {
            ...
            return new PagedList<MarketOrder_Area>(curTable.OrderBy(c => c.Order), pageIndex <= 0 ? 0 : pageIndex, pageSize, out count);
        }
    }
}
