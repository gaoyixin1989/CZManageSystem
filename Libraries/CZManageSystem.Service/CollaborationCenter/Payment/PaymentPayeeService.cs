...
{
    public partial class PaymentPayeeService : BaseService<PaymentPayee>, IPaymentPayeeService
    {
        /// <summary>
        /// 分页
        /// </summary>
        ...
        public override IEnumerable<dynamic> GetForPaging(out int count, object objs = null, int pageIndex = 0, int pageSize = int.MaxValue)
        {
            ...
            PagedList<PaymentPayee> pageList = new PagedList<PaymentPayee>(source, pageIndex <= 0 ? 0 : (pageIndex - 1), pageSize, out count);
