...
{
    public class VW_Birthcontrol_Survey_DataService : BaseService<VW_Birthcontrol_Survey_Data>, IVW_Birthcontrol_Survey_DataService
    {
        static Users _user;
        public IList<VW_Birthcontrol_Survey_Data> GetForPagingByCondition(Users user, out int count, BirthControlGEBuilder objs = null, int pageIndex = 0, int pageSize = int.MaxValue)
        {
