...
{
    public class VW_Birthcontrol_Children_DataService : BaseService<VW_Birthcontrol_Children_Data>, IVW_Birthcontrol_Children_DataService
    {
        static Users _user;
        public IList<VW_Birthcontrol_Children_Data> GetForPagingByCondition(Users user, out int count, BirthControlGEBuilder objs = null, int pageIndex = 0, int pageSize = int.MaxValue)
        {
