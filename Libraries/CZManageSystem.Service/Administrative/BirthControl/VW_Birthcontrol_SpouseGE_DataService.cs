...
{
    public class VW_Birthcontrol_SpouseGE_DataService : BaseService<VW_Birthcontrol_SpouseGE_Data>, IVW_Birthcontrol_SpouseGE_DataService
    {
        static Users _user;
        public IList<VW_Birthcontrol_SpouseGE_Data> GetForPagingByCondition(Users user, out int count, BirthControlGEBuilder objs = null, int pageIndex = 0, int pageSize = int.MaxValue)
        {
