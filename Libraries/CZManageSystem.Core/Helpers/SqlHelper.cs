...
namespace CZManageSystem.Core.Helpers
{
    public class SqlHelper
    {
        ...
        /// <returns></returns>
        public static string[] SqlBulkInsert(DataTable dt, string tablename)
        {
            int errorResult = 0;
            int affect = 0;
            ...
            using (SqlConnection conn = CreateConnection())
            {
                ...
                SqlTransaction scope = conn.BeginTransaction();
                try
                {
            ...
            return new string[] { "导入成功！" + dt.Rows.Count + "条" + "，失败" + errorResult + "条" + sbError.ToString(), dt.Rows.Count.ToString(), errorResult.ToString() };
        }
