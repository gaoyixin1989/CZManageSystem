...
{
    public class VW_Birthcontrol_Children_DataMap : EntityTypeConfiguration<VW_Birthcontrol_Children_Data>
    {
        public VW_Birthcontrol_Children_DataMap()
        {
            // Primary Key
          ...
          .HasMaxLength(50);
            ...
            this.ToTable("vw_Birthcontrol_Children_Data");
