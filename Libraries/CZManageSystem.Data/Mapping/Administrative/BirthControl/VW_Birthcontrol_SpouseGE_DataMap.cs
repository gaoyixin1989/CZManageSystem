...
{
    class VW_Birthcontrol_SpouseGE_DataMap : EntityTypeConfiguration<VW_Birthcontrol_SpouseGE_Data>
    {
        public VW_Birthcontrol_SpouseGE_DataMap()
        {
            // Primary Key
          ...
          .HasMaxLength(2);
            ...
            this.ToTable("vw_Birthcontrol_SpouseGE_Data");
