...
{
    public class OrderMeal_MealOrderMap : EntityTypeConfiguration<OrderMeal_MealOrder>
    {
        public OrderMeal_MealOrderMap()
        {
            // Primary Key
            this.HasKey(t => t.Id);
            /// <summary>
          ...
          .HasMaxLength(255);
            ...
            this.ToTable("OrderMeal_MealOrder");
            ...
            // 退餐时间
            this.Property(t => t.BackOrderTime).HasColumnName("BackOrderTime");
        }
