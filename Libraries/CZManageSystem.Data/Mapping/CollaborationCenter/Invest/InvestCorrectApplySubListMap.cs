...
{
	public class InvestCorrectApplySubListMap : EntityTypeConfiguration<InvestCorrectApplySubList>
	{
		public InvestCorrectApplySubListMap()
		{
			// Primary Key
			 this.HasKey(t => t.ID);
			...
			// Table & Column Mappings
 			 this.ToTable("InvestCorrectApplySubList"); 
			this.Property(t => t.ID).HasColumnName("ID"); 
			this.Property(t => t.EstimateID).HasColumnName("EstimateID"); 
