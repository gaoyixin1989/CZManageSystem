...
{
	public class V_Consumable_ConsumingDetailMap : EntityTypeConfiguration<V_Consumable_ConsumingDetail>
	{
		public V_Consumable_ConsumingDetailMap()
		{
			// Primary Key
			...
			// Table & Column Mappings
 			 this.ToTable("V_Consumable_ConsumingDetail"); 
